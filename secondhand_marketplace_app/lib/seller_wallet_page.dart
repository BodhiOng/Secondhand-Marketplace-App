  ...
  void _onItemTapped(int index) {
    ...
    switch (index) {
      ...
      case 2: // Already on Wallet page, just update index
        ...
        break;
      case 3: // Navigate to Messages page
        Navigator.pushReplacement(
          context,
          DarkPageReplaceRoute(page: const SellerMessagesPage()),
        );
        break;
      case 4: // Navigate to Profile page
        Navigator.pushReplacement(
          context,
                      ...
                      onPressed: () async {
                        ...
                        try {
                          ...
                          switch (selectedMethod) {
                            ...
                            case 'Online Banking':
                              description =
                                  'Online banking transfer to account';
                              break;
                            case 'E-Wallet':
                        ...
                        Container(
                          ...
                          child: DropdownButtonHideUnderline(
                            child: DropdownButton<String>(
                              ...
                              items:
                                  withdrawalMethods.map((String method) {
                                    return DropdownMenuItem<String>(
                                      value: method,
                                      child: Text(method),
                                    );
                      ...
                      onPressed: () async {
                        ...
                        try {
                          ...
                          scaffoldMessenger.showSnackBar(
                            SnackBar(
                              content: Text(
                                'Successfully withdrew RM ${amount.toStringAsFixed(2)}',
                              ),
                              backgroundColor: AppColors.mutedTeal,
                            ),
                          );
                            ...
                            child: ListView.separated(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return ListTile(
                                  ...
                                  onTap:
                                      transaction['relatedOrderId'] != null
                                          ? () {
