  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('My Reviews', style: TextStyle(color: AppColors.coolGray)),
        elevation: 0,
      ),
      body: _isLoading
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: AppColors.softLemonYellow.withAlpha(50),
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            decoration: BoxDecoration(
                                              color: AppColors.softLemonYellow.withAlpha(30),
                                              borderRadius: BorderRadius.circular(16),
                                            ),
                                            child: Row(
                                              children: [
                                      ...
                                      // Review text
                                      if ((review['review'] as String).isNotEmpty) ...[  
                                        const SizedBox(height: 16),
                                        Text(
